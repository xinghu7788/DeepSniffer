    ...
    def next_training_batch(self):
        while True:
            ...
            for sample in self.training_set:
                ...
                train_inputs, train_targets_sparse, original = scheduler_select_seg(train_inputs, train_targets, seg_table, 1)  # 0 for scheduler
    ...
    def next_testing_batch(self):
        while True:
            ...
            for sample in self.testing_set:
                ...
                from roi_selection_incept_dd import scheduler_select_seg            
                train_inputs, train_targets_sparse, original = scheduler_select_seg(train_inputs, train_targets, seg_table, 1) # 1 for complete
                train_seq_len = [train_inputs.shape[1]] 
